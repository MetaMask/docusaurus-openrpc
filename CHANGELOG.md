...
### Uncategorized
- Update coverage
- Update docs-react version to 0.1.2
- Removed injected html tags

## [0.2.1]
### Uncategorized
- Changed open-rpc-docs-react version to 0.1.1

## [0.2.0]
### Uncategorized
- Fixed coverage
- Fixed coverage
- Fixed linting + updated README
- Fixed bump docs react + fix options

## [0.1.1]
### Uncategorized
- Removed console.log
- Changed open-rpc-docs-react + fixed trailingSlash: true
...
- Fixed interactive box
- Fixed borders for right sidebar
- Fixed layout on mobile
- Fixed urls that were camel case deep links
...
[Unreleased]: https://github.com/MetaMask/docusaurus-openrpc/compare/v0.2.2...HEAD
...
[0.2.0]: https://github.com/MetaMask/docusaurus-openrpc/compare/v0.1.1...v0.2.0
[0.1.1]: https://github.com/MetaMask/docusaurus-openrpc/compare/v0.1.0...v0.1.1
