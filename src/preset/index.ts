// forked from: https://raw.githubusercontent.com/facebook/docusaurus/main/packages/docusaurus-preset-classic/src/index.ts
...
export default function preset(
  ...
  if (docs !== false) {
    plugins.push(makePluginConfig('../content-docs-enhanced-open-rpc', docs));
  }
  if (blog !== false) {
